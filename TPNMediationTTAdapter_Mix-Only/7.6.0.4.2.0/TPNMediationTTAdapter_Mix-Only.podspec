...
Pod::Spec.new do |s|
  ...
  s.license = { :type => "MIT", :file => "TPNTTAdapter_Mix-7.6.0.4.2.0/LICENSE" }
  ...
  s.source = {
    :http => "http://topon-sdk-release.oss-cn-hangzhou.aliyuncs.com/TPN_Release/iosnetwork_2/AnyThinkTTAdapter_Mix/7.6.0.4.2.0/AnyThinkTTAdapter_Mix-7.6.0.4.2.0.zip",
    :type => 'zip'
  }
  s.vendored_frameworks = "AnyThinkTTAdapter_Mix-7.6.0.4.2.0/AnyThinkTTAdapter_Mix.xcframework"
   
  s.dependency 'TPNiOS','>=6.5.60'
