...
Pod::Spec.new do |s|
  ...
  s.source = {
    :http => "http://topon-sdk-release.oss-cn-hangzhou.aliyuncs.com/TPN_Release/iosnetwork_2/AnyThinkGromoreAdapter/7.6.0.4.2.0/AnyThinkGromoreAdapter-7.6.0.4.2.0.zip",
    :type => 'zip'
  }
