...
Pod::Spec.new do |s|
  s.name             = 'TPNMediationGromoreAdapter-Only'
  s.version          = '7.6.0.4.0'
  s.summary          = 'TPNGromoreSDKAdapter used for mediation with the TopOn SDK'
  ...
  s.license = { :type => "MIT", :file => "AnyThinkGromoreAdapter-7.6.0.4.0/LICENSE" }
  ...
  s.source = {
    :http => "http://topon-sdk-release.oss-cn-hangzhou.aliyuncs.com/TPN_Release/iosnetwork/AnyThinkGromoreAdapter/7.6.0.4.0/AnyThinkGromoreAdapter-7.6.0.4.0.zip",
    :type => 'zip'
  }
