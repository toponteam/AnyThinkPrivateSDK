...
Pod::Spec.new do |s|
  ...
  s.license = { :type => "MIT", :file => "AnyThinkTTAdapter_Mix-7.6.0.4.0/LICENSE" }
  ...
  s.source = {
    :http => "http://topon-sdk-release.oss-cn-hangzhou.aliyuncs.com/AnyThink_Release/iosnetwork/AnyThinkTTAdapter_Mix/7.6.0.4.0/AnyThinkTTAdapter_Mix-7.6.0.4.0.zip",
    :type => 'zip'
  }
