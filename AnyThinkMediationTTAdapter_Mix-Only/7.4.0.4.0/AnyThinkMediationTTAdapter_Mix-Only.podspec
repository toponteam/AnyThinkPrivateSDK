...
Pod::Spec.new do |s|
  ...
  s.license = { :type => "MIT", :file => "AnyThinkTTAdapter_Mix-7.4.0.4.0/LICENSE" }
  ...
  s.source = {
    :http => "https://topon-sdk-release.oss-accelerate.aliyuncs.com/AnyThink_Release/iosnetwork/AnyThinkTTAdapter_Mix/7.4.0.4.0/AnyThinkTTAdapter_Mix-7.4.0.4.0.zip",
    :type => 'zip'
  }
  s.vendored_frameworks = "AnyThinkTTAdapter_Mix-7.4.0.4.0/AnyThinkTTAdapter_Mix.xcframework"
