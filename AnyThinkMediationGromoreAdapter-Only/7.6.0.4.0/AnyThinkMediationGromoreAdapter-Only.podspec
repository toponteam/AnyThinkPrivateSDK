...
Pod::Spec.new do |s|
  ...
  s.source = {
    :http => "http://topon-sdk-release.oss-cn-hangzhou.aliyuncs.com/AnyThink_Release/iosnetwork/AnyThinkGromoreAdapter/7.6.0.4.0/AnyThinkGromoreAdapter-7.6.0.4.0.zip",
    :type => 'zip'
  }
