#
# Be sure to run `pod lib lint AnyThinkGromoreSDKAdapter-Only.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license = { :type => "MIT", :file => "AnyThinkGromoreAdapter-7.4.0.0.0/LICENSE" }
  ...
  s.source = {
    :http => "https://topon-sdk-release.oss-accelerate.aliyuncs.com/AnyThink_Release/iosnetwork/AnyThinkGromoreAdapter/7.4.0.0.0/AnyThinkGromoreAdapter-7.4.0.0.0.zip",
    :type => 'zip'
  }
  s.vendored_frameworks = "AnyThinkGromoreAdapter-7.4.0.0.0/AnyThinkGromoreAdapter.xcframework"
