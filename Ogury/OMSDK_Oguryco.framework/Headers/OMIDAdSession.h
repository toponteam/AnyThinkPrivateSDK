 ...
 */
@property(nonatomic, readonly) OMIDOgurycoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDOgurycoAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDOgurycoAdSessionContext *)context
